    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin_applications" class="nav-link">
 ...
 --}}
  ...
  @yield('content')
   ...
   <footer class="main-footer">
    <strong>Copyright &copy; {{ now() }} <a href="https://deepnet.co.ke/">{{ env('APP_NAME') }}</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
   <a href="https://deepnet.co.ke/">    <b><b>Powered by Deepnet Labs : </b></b> </a>
    </div>
  </footer>
